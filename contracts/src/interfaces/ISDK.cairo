...
pub trait ISDK<TContractState> {
    ...
    fn is_blacklisted(self: @TContractState, account: ContractAddress, verified: bool) -> bool;
    fn verify_account(ref self: TContractState, account_to_verify: ContractAddress, protocol_name: Span<u8>);
