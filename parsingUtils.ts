import { CURVES, CurveId, G1Point, G2Point, findValueInStringToCurveId } from "./definitions.ts";
import { bitLength, hexStringToBytes, modInverse, split128, toBigInt, toHexStr } from "./io.ts";
...
export const createGroth16ProofFromSp1 = (vkey: Uint8Array, publicValues: Uint8Array, proof: Uint8Array): Groth16Proof => {
    ...
    const power253 = (BigInt(1) << BigInt(253)); // 2^253 using bit shift
